...
async def cmd_refine(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if opp_note:
            msg += f"{opp_note}\n"
        # Levels — all % distances from _pullback_entry (correct ref price)
            ...
            if _counter_dist_pct >= 5.0:
                ...
                try:
                    ...
                    if _c_rr >= 1.5:
                        ...
                        msg += (f"\nThe pullback to your long entry is "
                        ...
                        msg += f"\n`/refine {raw_symbol} {_counter_dir} {price_now:.4f} {leverage} scalp`"
                except Exception:
