...
async def cmd_watch(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        + conf_notes.get(confidence, "") + trail_note + tp_note + "\n\n"
            ...
            try:
                ...
                if entry and entry > 0:
                    try:
                        ...
                        _atr_s = _ta2.atr(_df_trail["high"], _df_trail["low"], _df_trail["close"], length=14)
                        ...
                        if gain_pct >= step_pct:
                            ...
                            new_sl   = round(entry * (1 + lock_pct/100), 4) if direction == "LONG"                                        else round(entry * (1 - lock_pct/100), 4)
                            sl_improved = (
                                trail_sl is None or
