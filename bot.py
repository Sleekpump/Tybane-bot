...
async def cmd_refine(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # when ADX confirms momentum: pullbacks may never come in strong trends.
        if strong_trend_override and entry_check["action"] in ("WAIT", "CONDITIONAL", "NEUTRAL"):
        ...
        action_icon = {"ENTER":"✅","WAIT":"⏳","CONDITIONAL":"🟡","NEUTRAL":"⚪"}.get(action,"⚪")
