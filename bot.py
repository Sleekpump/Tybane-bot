        ...
        try:
            ...
            for r in results:
                ...
                if exh.get("short_opp") and now - alpha_state["last_signals"].get(symbol, 0) >= ALPHA_COOLDOWN:
                    # Check BTC circuit breaker doesn't block SHORTs
                    from risk_manager import calc_levels_v2
                    ...
                    # Override direction to SHORT for display
                    r_short = dict(r)
                    ...
                    log.info("Alpha SHORT alert: " + labels.get(symbol, symbol) + " | " + exh.get("reason",""))
                    continue
