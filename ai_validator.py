...
AI_MIN_QUALITY_TO_CALL = 65      # raised: only call AI on strong signals (saves ~50% tokens)
...
GEMINI_MODEL   = os.getenv("GEMINI_MODEL", "gemini-2.5-flash-lite-preview-06-17")  # override via env var
try:
