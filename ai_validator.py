...
def validate_signal_with_gemini(
    ...
    try:
        ...
        # generation_config as dict works across SDK versions;
        # GenerationConfig object also accepted but dict is safer
        try:
        ...
        log.error(f"Gemini validation error for {symbol}: {e}")
        return default
